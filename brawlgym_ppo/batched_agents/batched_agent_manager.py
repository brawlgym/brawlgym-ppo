...
from brawlgym_ppo.batched_agents import BatchedTrajectory, comm_consts
from brawlgym_ppo.batched_agents.batched_agent import batched_agent_process
from brawlgym_ppo.util import WelfordRunningStat
...
class BatchedAgentManager(object):
    ...
    def _get_env_shapes(self):
        ...
        while not done:
            ...
            if header == comm_consts.ENV_SHAPES_HEADER:
                ...
                obs_shape, action_shape, action_space_type = data[:3]
    ...
    def init_processes(
        ...
        :param build_env_fn: A function to build the environment for each process. Called with the process's game port.
